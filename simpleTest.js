...
// DONE: Only show stack traces if you clicked expand.
...
var TinyTestHelper = {
    renderStats: function(tests, failures) {
        ...
        // Number of successes.
        // Number of failures.
        var numbersOfTests = Object.keys(tests).length;
        var successes = numbersOfTests - failures;
        var summaryString = 'Ran ' + numbersOfTests + ' tests: '
                                        + successes + ' successes, ' 
                                        + failures + ' failures ';
